(function ($) {
    ...
    jQuery.extend(Shipping.prototype, {
        ...
        func_render_grid_view_row: function (data, idx) {
            var html = '';
            html += '<tr id=' + data.ship_des_id + '>';
            html += '<td class="text-center">' + data.ship_des_id + '</td>';
            html += '<td class="text-left">' + data.ship_des_name + '</td>';
            html += '<td class="text-left">' + data.ship_des_addr + '</td>';
            html += '<td class="text-center">' + data.ship_des_tel + '</td>';
        ...
        func_detail: function (self) {
            const id = self.id;
            izanagi('shipping-destinations/detail', 'post', {id: id}, null, jQuery.Shipping.func_detail_callback);
        },
