        ...
        <form id="form-goods-his">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    <input id="work-date-from" type="text" name="work_date_from" class="form-control input-time datepicker" value="<?php echo e(date(DATE_FORMAT)); ?>">
                </div>
            </div>
            <div class="form-group">
                <label id="label-work-date-to">出庫日to</label>
                <div class="input-group someOtherWidget">
                    <input id="work-date-to" name="work_date_to" class="form-control input-time datepicker" value="<?php echo e(date(DATE_FORMAT)); ?>">
                </div>
            </div>
            <div class="form-group">
