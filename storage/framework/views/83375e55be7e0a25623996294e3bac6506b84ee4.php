                    ...
                    <table id="goods-history-table" class="table table-bordered table-hover">
                        ...
                        <?php $__currentLoopData = $model; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr id="<?php echo e($row->id.'-'.$row->index); ?>">
                                ...
                                <td class="text-center"><?php echo e($row->work_date == null ? '' : date(DATE_FORMAT,  strtotime($row->work_date))); ?></td>
                                ...
                                <td class="text-center"><?php echo e($row->ship_date == null ? '' : date('H:i', strtotime($row->ship_date))); ?></td>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/vagrant/code/source/resources/views/goods-history/index.blade.php ENDPATH**/ ?>